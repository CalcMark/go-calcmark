...
func getFunctions() []Feature {
	features := []Feature{
		...
		},
		{
			...
			Category:    CategoryFunction,
			Subcategory: "Math",
			Syntax:      "accumulate(rate, time_period)",
		...
		},
		{
			...
			Category:    CategoryFunction,
			Subcategory: "Network",
			Syntax:      "downtime(availability_percent, time_period)",
	...
	features := []Feature{
		{
			...
			Category:    CategoryFunction,
			Subcategory: "Growth",
			Syntax:      "compound(principal, rate, duration, period?)",
		...
		},
		{
			...
			Category:    CategoryFunction,
			Subcategory: "Growth",
			Syntax:      "grow(starting_amount, increment, duration)",
		...
		},
		{
			...
			Category:    CategoryFunction,
			Subcategory: "Growth",
			Syntax:      "depreciate(principal, rate, duration, salvage?)",
