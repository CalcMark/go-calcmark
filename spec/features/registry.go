...
func getNetworkFeatures() []Feature {
	return []Feature{
		...
		},
		{
			Name:        "10g",
			Category:    CategoryNetwork,
			Syntax:      "throughput(10g)",
			Description: "10 Gbps network (~1.25 GB/s)",
			Aliases:     []string{"ten_gig"},
			Example:     "throughput(10g) → 1250 MB/s",
		},
		{
			Name:        "100g",
			Category:    CategoryNetwork,
			Syntax:      "throughput(100g)",
			Description: "100 Gbps network (~12.5 GB/s)",
			Aliases:     []string{"hundred_gig"},
			Example:     "throughput(100g) → 12500 MB/s",
		},
		{
			Name:        "wifi",
			Category:    CategoryNetwork,
		...
		},
		{
			Name:        "4g",
			Category:    CategoryNetwork,
			Syntax:      "throughput(4g)",
			Description: "4G mobile network (~2.5 MB/s)",
			Aliases:     []string{"four_g"},
			Example:     "throughput(4g) → 2.5 MB/s",
		},
		{
			Name:        "5g",
			Category:    CategoryNetwork,
			Syntax:      "throughput(5g)",
			Description: "5G mobile network (~50 MB/s)",
			Aliases:     []string{"five_g"},
			Example:     "throughput(5g) → 50 MB/s",
		},
	}
}
