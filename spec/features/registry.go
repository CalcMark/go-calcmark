...
func getFunctions() []Feature {
	features := []Feature{
		...
		},
		{
			...
			Category:    CategoryFunction,
			Subcategory: "Math",
			Syntax:      "sum(value1, value2, ...) or sum(table.column)",
			Description: "Calculate the sum of values, or of a named table's column",
		...
		},
		{
			...
			Category:    CategoryFunction,
			Subcategory: "Math",
			Syntax:      "min(value1, value2, ...) or min(table.column)",
			Description: "The smallest of the values, or of a named table's column",
			Example:     "min(4, 9, 1) → 1",
		},
		{
			Name:        "max",
			Category:    CategoryFunction,
			Subcategory: "Math",
			Syntax:      "max(value1, value2, ...) or max(table.column)",
			Description: "The largest of the values, or of a named table's column",
			Example:     "max(4, 9, 1) → 9",
		},
		{
			Name:        "count",
			Category:    CategoryFunction,
			Subcategory: "Math",
			Syntax:      "count(table.column) or count(value1, value2, ...)",
			Description: "How many values there are — the number of rows in a named table's column",
			Example:     "count(rates.role) → 2",
		},
		{
			Name:        "sqrt",
			Category:    CategoryFunction,
