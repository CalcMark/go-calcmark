...
func TestTokenizeCurrency(t *testing.T) {
	tests := []struct {
		...
		{"simple currency", "$100", CURRENCY, "$:100"},
		{"currency with commas", "$1,000", CURRENCY, "$:1000"},
		{"currency with decimals", "$1,500.50", CURRENCY, "$:1500.50"},
	}
